                    ...
                    <div>
                        ...
                        <form onSubmit={handleOrderSubmit}>
                            <div className="relative mb-4">
                                ...
                                <input type="text" name='country-region' placeholder='Country/Region' className="w-full bg-formBg dark:bg-darkFormBg rounded border border-gray-300 dark:border-navDark focus:border-indigo-500 focus:ring-2 text-base outline-none text-gray-700 dark:text-ternary py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onBlur={handleOnBlur} />
                            </div>
                            <div className="relative mb-4">
                                <label for="street-address" className="leading-7 text-sm text-gray-600 dark:text-white">Street Address</label>
                                <input type="text" name='street-address' placeholder='treet Address' className="w-full bg-formBg dark:bg-darkFormBg rounded border border-gray-300 dark:border-navDark focus:border-indigo-500 focus:ring-2 text-base outline-none text-gray-700 dark:text-ternary py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onBlur={handleOnBlur} />
                            </div>
                            <div className="relative mb-4">
                                <label for="town-city" className="leading-7 text-sm text-gray-600 dark:text-white">Town/City</label>
                                <input type="text" name='town-city' placeholder='Town/City' className="w-full bg-formBg dark:bg-darkFormBg rounded border border-gray-300 dark:border-navDark focus:border-indigo-500 focus:ring-2 text-base outline-none text-gray-700 dark:text-ternary py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onBlur={handleOnBlur} />
                            </div>
                            <div className="relative mb-4">
                                <label for="zip-code" className="leading-7 text-sm text-gray-600 dark:text-white">Zip Code</label>
                                <input type="text" name='zip-code' placeholder='Zip Code' className="w-full bg-formBg dark:bg-darkFormBg rounded border border-gray-300 dark:border-navDark focus:border-indigo-500 focus:ring-2 text-base outline-none text-gray-700 dark:text-ternary py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onBlur={handleOnBlur} />
                            </div>
                            <div className="relative mb-4">
                                <label for="phone" className="leading-7 text-sm text-gray-600 dark:text-white">Your Number</label>
                                <input type="text" name='phone' placeholder='Your Number' className="w-full bg-formBg dark:bg-darkFormBg rounded border border-gray-300 dark:border-navDark focus:border-indigo-500 focus:ring-2 text-base outline-none text-gray-700 dark:text-ternary py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onBlur={handleOnBlur} />
                            </div>
                            {
                                orderSuccess && (
