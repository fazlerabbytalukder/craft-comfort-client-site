...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font dark:bg-navDark dark:border-t dark:border-gray-800">
            <div className="container px-5 py-14 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    ...
                    <p className="mt-2 text-sm text-gray-500">Craft with comfort is now considered as a well-known furniture brand in Bangladesh. With the utmost promise to provide the finest home and office furniture CWC started its journey in 2013.</p>
                </div>
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="text-lg text-gray-900 font-semibold mb-3 dark:text-ternary">MY ACCOUNT</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="text-lg text-gray-900 font-semibold mb-3 dark:text-ternary">INFORMATION</h2>
                        <nav className="list-none mb-2">
                            <li className='mb-2'>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="text-lg text-gray-900 font-semibold mb-3 dark:text-ternary">CUSTOMER SERVICE</h2>
                        <nav className="list-none mb-2">
                            <li className='mb-2'>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="text-lg text-gray-900 font-semibold mb-3 dark:text-ternary">CONTACT</h2>
                        <nav className="list-none mb-2">
            ...
            <div className="bg-gray-100 dark:bg-navDark dark:border-t dark:border-gray-800">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Craft Comfort —
                        <a href="https://www.linkedin.com/in/fazle-rabby-talukder/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@fazlerabby</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        <a className="text-gray-500 hover:text-bluShade dark:hover:text-ternary" href='https://www.facebook.com/frtfazlerabby/'>
                            <FaFacebookF />
                        </a>
                        <a className="ml-3 text-gray-500 hover:text-bluShade dark:hover:text-ternary" href='https://twitter.com/'>
                            <BsTwitter />
                        </a>
                        <a className="ml-3 text-gray-500 hover:text-bluShade dark:hover:text-ternary" href='https://www.instagram.com/fazle.rabby.talukder/'>
                            <FaInstagram />
                        </a>
                        <a className="ml-3 text-gray-500 hover:text-bluShade dark:hover:text-ternary" href='https://www.linkedin.com/in/fazle-rabby-talukder/'>
                            <AiFillLinkedin />
                        </a>
                    </span>
                </div>
